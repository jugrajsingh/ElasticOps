...
class Job(Base):
    ...
    target_index: Mapped[str | None] = mapped_column(String(512), nullable=True)
    shard_number: Mapped[int | None] = mapped_column(Integer, nullable=True)
    from_node: Mapped[str | None] = mapped_column(String(255), nullable=True)
    to_node: Mapped[str | None] = mapped_column(String(255), nullable=True)
